...
class ModelRunBase(models.Model):
...
class ModelRunListing(ModelRunBase):
    class Meta:
        managed = False
        db_table = 'core_modelrun'

    parent = models.ForeignKey("ModelRunListing", null=True, blank=True, on_delete=models.CASCADE, related_name="children")
